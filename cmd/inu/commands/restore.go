...
Requires an entities YAML file generated by the anonymize command.`,
	...
	cmd.Flags().StringVarP(&restoreFile, "file", "f", "", "Read anonymized text from file")
	cmd.Flags().StringVarP(&restoreContent, "content", "c", "", "Anonymized text as string")
	cmd.Flags().StringVarP(&restoreEntities, "entities", "e", "", "Entities YAML file (required)")
	cmd.Flags().BoolVarP(&restorePrint, "print", "p", false, "Print restored text to stdout")
	cmd.Flags().StringVarP(&restoreOutput, "output", "o", "", "Write restored text to file")
...
func runRestore(cmd *cobra.Command, args []string) error {
	...
	if err := cli.WriteOutput(result, restorePrint, restoreOutput); err != nil {
		return err
	}
