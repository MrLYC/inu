...
## Overview
本设计文档描述如何实现 `inu interactive` 交互式命令，该命令将匿名化和还原操作结合在一个交互式流程中，支持用户在中间进行文本处理。
...
# 输出：
<个人信息[0].姓名.全名>的电话是<个人信息[1].电话.13800138000>
...
### Unit Tests
- `TestInteractiveCommand_Anonymize`: 测试匿名化阶段
...
### 提示信息
- **匿名化完成**: `Anonymized text (entities saved internally):`
